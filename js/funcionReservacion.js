...
function traerInformacionReservacion() {
    $.ajax({
        url: "http://152.70.222.238:8080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacionReservacion() {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Reservation/save",
...
function borrarElementoReserva(idReserva) {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Reservation/"+idReserva,
...
function editarInformacionReserva(idReserva) {
    ...
    $.ajax({
        url: "http://152.70.222.238:8080/api/Reservation/update",
        type: "PUT",
        data: dataToSend,
