...
function traerInformacionClientes() {
    $.ajax({
        url: "http://152.70.222.238:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacionClientes() {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Client/save",
...
function borrarElementoClientes(idCli) {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Client/"+idCli,
...
function editarInformacionClientes(idCli) {
    ...
    $.ajax({
        url: "http://152.70.222.238:8080/api/Client/update",
        type: "PUT",
        data: dataToSend,
