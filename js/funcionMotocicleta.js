...
function traerInformacionMotorbike() {
    $.ajax({
        url: "http://152.70.222.238:8080/api/Motorbike/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacionMotorbike() {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Motorbike/save",
...
function borrarElementoMoto(idMoto) {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Motorbike/"+idMoto,
...
function editarInformacionMoto(idMoto) {
    ...
    $.ajax({
        url: "http://152.70.222.238:8080/api/Motorbike/update",
        type: "PUT",
        data: dataToSend,
...
function CargarCategorias(){
    var datos;
    $.ajax({
        url:"http://152.70.222.238:8080/api/Category/all",
        type:"GET",
        async: false,
        datatype:"JSON",
        success:function(respuesta){
