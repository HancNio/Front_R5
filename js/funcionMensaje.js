...
function traerInformacionMensaje() {
    $.ajax({
        url: "http://152.70.222.238:8080/api/Message/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacionMensaje() {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Message/save",
...
function borrarElementoMensaje(idMensaje) {
    ...
    $.ajax({
        ...
        url: "http://152.70.222.238:8080/api/Message/"+idMensaje,
...
function editarInformacionMensaje(idMensaje) {
    ...
    $.ajax({
        url: "http://152.70.222.238:8080/api/Message/update",
        type: "PUT",
        data: dataToSend,
